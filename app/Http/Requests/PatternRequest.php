...
class PatternRequest extends FormRequest
{
    ...
    public function rules()
    {
      switch ($this->method()){
          case 'POST' : {
            return [
              'name' => 'required|string|min:4|max:50|unique:patterns|regex:/^[^\d]*$/',
            ];
          }
          case 'PUT' : {
