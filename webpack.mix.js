...
// Admin Derictory
mix.js('resources/admin/assets/js/products/create-validation.js', 'public/admin/assets/js/products/')
   .js('resources/admin/assets/js/products/edit-validation.js', 'public/admin/assets/js/products/')
   .js('resources/admin/assets/js/products/data-form-validation.js', 'public/admin/assets/js/products/')
   ...
   .js('resources/admin/assets/js/patterns/data-form-validation.js', 'public/admin/assets/js/patterns/')
   .js('resources/admin/assets/js/materials/data-form-validation.js', 'public/admin/assets/js/materials/')
   .js('resources/admin/assets/js/home_styles/data-form-validation.js', 'public/admin/assets/js/home_styles/')
   .js('resources/admin/assets/js/colors/data-form-validation.js', 'public/admin/assets/js/colors/')
   .js('resources/admin/assets/js/auth/login-data-form-validation.js', 'public/admin/assets/js/auth/');
