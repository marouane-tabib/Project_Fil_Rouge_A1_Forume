          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('category.edit', $category->id) }}"><i class="ti ti-pencil me-1"></i>Edit</a>
                ...
                <form action="{{ route('category.destroy' , $category->id) }}" method="post" class="d-none" id="delete-category-{{ $category->id }}" >
                  @csrf
                  @method('DELETE')
                </form>
              </div>
