    ...
    <div class="card card-action mb-4">
      ...
      <div class="collapse show">
        <div class="card-body">
          ...
          <p class="card-text">Click on <i class="tf-icons ti ti-chevron-right scaleX-n1-rtl ti-sm"></i> to see card collapse in action.</p>
        </div>
      </div>
    </div>
  </div>
  <div class="col-md">
    <div class="card card-action mb-4">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Click on <i class="tf-icons ti ti-rotate-clockwise-2 scaleX-n1-rtl ti-sm"></i> icon to see refresh card content in action.</p>
      </div>
    </div>
  </div>
  <div class="w-100"></div>
  <div class="col-md">
    <div class="card card-action mb-4">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Click on <i class="tf-icons ti ti-arrows-maximize ti-sm"></i> icon to see expand card in action.</p>
      </div>
    </div>
  </div>
  <div class="col-md">
