      ...
      <div id="checkout-confirmation" class="content">
        <div class="row mb-3">
          <div class="col-12 col-lg-8 offset-lg-2 text-center mb-3">
            ...
            <p><span class="fw-semibold"><i class="ti ti-clock me-1"></i> Time placed:</span> 25/05/2020 13:35pm</p>
          </div>
          ...
          <div class="col-xl-3">
            <div class="border rounded p-4 pb-3">
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-sm-6 text-end"><s>$5.00</s> <span class="badge bg-label-success ms-1">Free</span></dd>
              </dl>
              <hr class="mx-n4">
              <dl class="row mb-0">
                <dt class="col-6">Total</dt>
