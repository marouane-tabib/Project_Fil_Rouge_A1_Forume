...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="{{url('pages/profile-connections')}}"><i class='ti ti-link ti-xs me-1'></i> Connections</a></li>
    </ul>
  </div>
</div>
<!--/ Navbar pills -->
      ...
      <div class="card-header">
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">Social Banners</a></h5>
              <div class="client-info"><strong>Client: </strong><span class="text-muted">Christian Jimenez</span></div>
            </div>
          </div>
          <div class="ms-auto">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><strong>Client: </strong><span class="text-muted">Jeffrey Phillips</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown zindex-2">
    ...
    <div class="card">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><strong>Client: </strong><span class="text-muted">Ricky McDonald</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown zindex-2">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center pt-1">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body"><i class="ti ti-message-dots ti-sm"></i> 98</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><strong>Client: </strong><span class="text-muted">Hulda Wright</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown zindex-2">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center pt-1">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body"><i class="ti ti-message-dots ti-sm"></i> 120</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><strong>Client: </strong><span class="text-muted">Jerry Greene</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown zindex-2">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center pt-1">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body"><i class="ti ti-message-dots ti-sm"></i> 20</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><strong>Client: </strong><span class="text-muted">Olive Strickland</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown zindex-2">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center pt-1">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body"><i class="ti ti-message-dots ti-sm"></i> 37</a>
          </div>
        </div>
      </div>
    </div>
