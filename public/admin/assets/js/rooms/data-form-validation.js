...
/***/ "./resources/admin/assets/js/rooms/data-form-validation.js":
/*!*****************************************************************!*\
  !*** ./resources/admin/assets/js/rooms/data-form-validation.js ***!
  \*****************************************************************/
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (/******/function () {
      ...
      document.addEventListener('DOMContentLoaded', function (e) {
        (function () {
          var formValidationExamples = document.getElementById('createRoomForm');
          var fv = FormValidation.formValidation(formValidationExamples, {
            fields: {
              name: {
                validators: {
                  notEmpty: {
                    message: 'Please make sure to enter a room name.'
                  },
                  stringLength: {
                    min: 4,
                    max: 50,
                    message: 'The room name must be between 4 and 50 characters in length.'
                  },
                  regexp: {
                    regexp: /^[^\d]*$/,
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/admin/assets/js/rooms/data-form-validation.js");
/******/ 	
/******/ 	return __webpack_exports__;
/******/ })()
;
