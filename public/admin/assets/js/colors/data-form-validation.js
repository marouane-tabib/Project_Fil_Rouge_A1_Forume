...
/***/ "./resources/admin/assets/js/colors/data-form-validation.js":
/*!******************************************************************!*\
  !*** ./resources/admin/assets/js/colors/data-form-validation.js ***!
  \******************************************************************/
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (/******/function () {
      ...
      document.addEventListener('DOMContentLoaded', function (e) {
        (function () {
          var formValidationExamples = document.getElementById('createColorForm');
          var fv = FormValidation.formValidation(formValidationExamples, {
            fields: {
              name: {
                validators: {
                  notEmpty: {
                    message: 'Please make sure to enter a color name.'
                  },
                  stringLength: {
                    min: 4,
                    max: 50,
                    message: 'The color name must be between 4 and 50 characters in length.'
                  },
                  regexp: {
                    regexp: /^[^\d]*$/,
                    message: 'The color name can only contain alphabetical and space characters.'
                  }
                }
              }
            },
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/admin/assets/js/colors/data-form-validation.js");
/******/ 	
/******/ 	return __webpack_exports__;
/******/ })()
;
